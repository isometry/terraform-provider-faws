...
const (
	packageName = "osis"
	awsEnvVar   = "AWS_ENDPOINT_URL_OSIS"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "osis"

	aliasName0 = "opensearchingestion"
)
...
func defaultEndpoint(region string) (url.URL, error) {
	r := osis.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), osis.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	client := meta.OpenSearchIngestionClient(ctx)
