...
const (
	packageName = "launchwizard"
	awsEnvVar   = "AWS_ENDPOINT_URL_LAUNCH_WIZARD"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "launch_wizard"
)
...
func defaultEndpoint(region string) (url.URL, error) {
	r := launchwizard.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), launchwizard.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	client := meta.LaunchWizardClient(ctx)
