...
const (
	packageName = "pipes"
	awsEnvVar   = "AWS_ENDPOINT_URL_PIPES"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := pipes.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), pipes.EndpointParameters{
