...
const (
	packageName = "pcs"
	awsEnvVar   = "AWS_ENDPOINT_URL_PCS"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := pcs.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), pcs.EndpointParameters{
