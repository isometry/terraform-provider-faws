...
func TestAccQuickSightDataSource_tags(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ConfigDirectory: config.StaticDirectory("testdata/DataSource/tags/"),
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckDataSourceExists(ctx, resourceName, &v),
				),
...
func TestAccQuickSightDataSource_tags_null(t *testing.T) {
...
func TestAccQuickSightDataSource_tags_EmptyTag_OnCreate(t *testing.T) {
...
func TestAccQuickSightDataSource_tags_EmptyTag_OnUpdate_Add(t *testing.T) {
	t.Skip("Resource DataSource does not support empty tags")
...
func TestAccQuickSightDataSource_tags_EmptyTag_OnUpdate_Replace(t *testing.T) {
	t.Skip("Resource DataSource does not support empty tags")
...
func TestAccQuickSightDataSource_tags_DefaultTags_providerOnly(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/DataSource/tags_defaults/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
...
func TestAccQuickSightDataSource_tags_DefaultTags_emptyResourceTag(t *testing.T) {
	t.Skip("Resource DataSource does not support empty tags")
...
func TestAccQuickSightDataSource_tags_DefaultTags_emptyProviderOnlyTag(t *testing.T) {
	t.Skip("Resource DataSource does not support empty tags")
...
func TestAccQuickSightDataSource_tags_DefaultTags_nullOverlappingResourceTag(t *testing.T) {
	t.Skip("Resource DataSource does not support null tags")
...
func TestAccQuickSightDataSource_tags_DefaultTags_nullNonOverlappingResourceTag(t *testing.T) {
	t.Skip("Resource DataSource does not support null tags")
...
func TestAccQuickSightDataSource_tags_ComputedTag_OnCreate(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/DataSource/tagsComputed1/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
...
func TestAccQuickSightDataSource_tags_ComputedTag_OnUpdate_Add(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/DataSource/tagsComputed2/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
					"unknownTagKey": config.StringVariable("computedkey1"),
...
func TestAccQuickSightDataSource_tags_IgnoreTags_Overlap_DefaultTag(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/DataSource/tags_ignore/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
					acctest.CtProviderTags: config.MapVariable(map[string]config.Variable{
						acctest.CtProviderKey1: config.StringVariable(acctest.CtProviderValue1),
