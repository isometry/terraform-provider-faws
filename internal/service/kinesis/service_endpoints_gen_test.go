...
const (
	packageName = "kinesis"
	awsEnvVar   = "AWS_ENDPOINT_URL_KINESIS"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := kinesis.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), kinesis.EndpointParameters{
