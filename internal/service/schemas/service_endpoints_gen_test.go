...
const (
	packageName = "schemas"
	awsEnvVar   = "AWS_ENDPOINT_URL_SCHEMAS"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := schemas.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), schemas.EndpointParameters{
