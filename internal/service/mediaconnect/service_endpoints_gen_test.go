...
const (
	packageName = "mediaconnect"
	awsEnvVar   = "AWS_ENDPOINT_URL_MEDIACONNECT"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "mediaconnect"
)
...
func defaultEndpoint(region string) (url.URL, error) {
	r := mediaconnect.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), mediaconnect.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	client := meta.MediaConnectClient(ctx)
