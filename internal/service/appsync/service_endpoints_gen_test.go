...
const (
	packageName = "appsync"
	awsEnvVar   = "AWS_ENDPOINT_URL_APPSYNC"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := appsync.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), appsync.EndpointParameters{
