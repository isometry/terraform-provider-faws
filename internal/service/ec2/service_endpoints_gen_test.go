...
const (
	packageName = "ec2"
	awsEnvVar   = "AWS_ENDPOINT_URL_EC2"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := ec2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), ec2.EndpointParameters{
