...
const (
	packageName = "pricing"
	awsEnvVar   = "AWS_ENDPOINT_URL_PRICING"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := pricing.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), pricing.EndpointParameters{
