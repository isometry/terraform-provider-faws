...
const (
	packageName = "accessanalyzer"
	awsEnvVar   = "AWS_ENDPOINT_URL_ACCESSANALYZER"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "accessanalyzer"
)
...
func defaultEndpoint(region string) (url.URL, error) {
	r := accessanalyzer.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), accessanalyzer.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	client := meta.AccessAnalyzerClient(ctx)
