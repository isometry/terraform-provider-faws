...
const (
	...
	awsEnvVar   = "AWS_ENDPOINT_URL_NETWORKMANAGER"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "networkmanager"
)
...
func defaultEndpoint(region string) (url.URL, error) {
	r := networkmanager.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), networkmanager.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	client := meta.NetworkManagerClient(ctx)
