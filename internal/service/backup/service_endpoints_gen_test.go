...
const (
	packageName = "backup"
	awsEnvVar   = "AWS_ENDPOINT_URL_BACKUP"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := backup.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), backup.EndpointParameters{
