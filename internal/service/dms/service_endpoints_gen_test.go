...
func defaultEndpoint(region string) (url.URL, error) {
	r := databasemigrationservice.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), databasemigrationservice.EndpointParameters{
