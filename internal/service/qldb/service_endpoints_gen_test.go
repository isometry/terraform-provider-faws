...
const (
	packageName = "qldb"
	awsEnvVar   = "AWS_ENDPOINT_URL_QLDB"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := qldb.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), qldb.EndpointParameters{
