...
const (
	...
	aliasName2ConfigEndpoint = "https://aliasname2-config.endpoint.test/"
)

const (
	packageName = "lexmodels"
	awsEnvVar   = "AWS_ENDPOINT_URL_LEX_MODEL_BUILDING_SERVICE"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "lex_model_building_service"

	aliasName0 = "lexmodelbuilding"
	aliasName1 = "lexmodelbuildingservice"
	aliasName2 = "lex"
)
...
func TestEndpointConfiguration(t *testing.T) { //nolint:paralleltest // uses t.Setenv
	...
	testcases := map[string]endpointTestCase{
		...
		"alias name 1 endpoint config overrides alias name 2 config": {
			with: []setupFunc{
				withAliasName1EndpointInConfig,
				withAliasName2EndpointInConfig,
			},
		...
		// Alias name 2 endpoint on Config

		"alias name 2 endpoint config": {
			with: []setupFunc{
				withAliasName2EndpointInConfig,
			},
			expected: expectAliasName2ConfigEndpoint(),
		},

		"alias name 2 endpoint config overrides aws service envvar": {
			with: []setupFunc{
				withAliasName2EndpointInConfig,
				withAwsEnvVar,
			},
		...
		"alias name 2 endpoint config overrides base envvar": {
			with: []setupFunc{
				withAliasName2EndpointInConfig,
				withBaseEnvVar,
			},
		...
		"alias name 2 endpoint config overrides service config file": {
			with: []setupFunc{
				withAliasName2EndpointInConfig,
				withServiceEndpointInConfigFile,
			},
		...
		"alias name 2 endpoint config overrides base config file": {
			with: []setupFunc{
				withAliasName2EndpointInConfig,
				withBaseEndpointInConfigFile,
			},
...
func defaultEndpoint(region string) (url.URL, error) {
	r := lexmodelbuildingservice.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), lexmodelbuildingservice.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	client := meta.LexModelsClient(ctx)
...
func expectAliasName2ConfigEndpoint() caseExpectations {
	return caseExpectations{
		endpoint: aliasName2ConfigEndpoint,
		region:   expectedCallRegion,
	}
}
