...
import (
	...
	tfiot "github.com/isometry/terraform-provider-faws/internal/service/iot"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					acctest.CheckResourceAttrRegionalARN(ctx, resourceName, names.AttrARN, "iot", fmt.Sprintf("rule/%s", rName)),
...
// Reference: https://github.com/isometry/terraform-provider-faws/issues/16115
