...
const (
	packageName = "iot"
	awsEnvVar   = "AWS_ENDPOINT_URL_IOT"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := iot.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), iot.EndpointParameters{
