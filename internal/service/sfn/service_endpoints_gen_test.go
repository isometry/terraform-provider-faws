...
const (
	packageName = "sfn"
	awsEnvVar   = "AWS_ENDPOINT_URL_SFN"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "sfn"

	aliasName0 = "stepfunctions"
)
...
func defaultEndpoint(region string) (url.URL, error) {
	r := sfn.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), sfn.EndpointParameters{
