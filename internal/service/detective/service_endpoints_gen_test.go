...
const (
	...
	awsEnvVar   = "AWS_ENDPOINT_URL_DETECTIVE"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "detective"
)
...
func defaultEndpoint(region string) (url.URL, error) {
	r := detective.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), detective.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	client := meta.DetectiveClient(ctx)
