...
const (
	...
	awsEnvVar   = "AWS_ENDPOINT_URL_MEDIAPACKAGE"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "mediapackage"
)
...
func defaultEndpoint(region string) (url.URL, error) {
	r := mediapackage.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), mediapackage.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	client := meta.MediaPackageClient(ctx)
