...
const (
	packageName = "glue"
	awsEnvVar   = "AWS_ENDPOINT_URL_GLUE"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := glue.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), glue.EndpointParameters{
