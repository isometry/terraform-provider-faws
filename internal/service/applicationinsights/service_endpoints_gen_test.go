...
const (
	...
	awsEnvVar   = "AWS_ENDPOINT_URL_APPLICATION_INSIGHTS"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "application_insights"
)
...
func defaultEndpoint(region string) (url.URL, error) {
	r := applicationinsights.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), applicationinsights.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	client := meta.ApplicationInsightsClient(ctx)
