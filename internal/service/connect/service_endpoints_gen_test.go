...
const (
	packageName = "connect"
	awsEnvVar   = "AWS_ENDPOINT_URL_CONNECT"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := connect.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), connect.EndpointParameters{
