...
const (
	packageName = "internetmonitor"
	awsEnvVar   = "AWS_ENDPOINT_URL_INTERNETMONITOR"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "internetmonitor"
)
...
func defaultEndpoint(region string) (url.URL, error) {
	r := internetmonitor.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), internetmonitor.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	client := meta.InternetMonitorClient(ctx)
