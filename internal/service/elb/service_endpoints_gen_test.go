...
const (
	packageName = "elb"
	awsEnvVar   = "AWS_ENDPOINT_URL_ELASTIC_LOAD_BALANCING"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "elastic_load_balancing"

	aliasName0 = "elasticloadbalancing"
)
...
func defaultEndpoint(region string) (url.URL, error) {
	r := elasticloadbalancing.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), elasticloadbalancing.EndpointParameters{
