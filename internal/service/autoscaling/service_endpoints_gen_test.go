...
const (
	...
	awsEnvVar   = "AWS_ENDPOINT_URL_AUTO_SCALING"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := autoscaling.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), autoscaling.EndpointParameters{
