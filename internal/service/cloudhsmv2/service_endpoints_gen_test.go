...
const (
	packageName = "cloudhsmv2"
	awsEnvVar   = "AWS_ENDPOINT_URL_CLOUDHSM_V2"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "cloudhsm_v2"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := cloudhsmv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), cloudhsmv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	client := meta.CloudHSMV2Client(ctx)
