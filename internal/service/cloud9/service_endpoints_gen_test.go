...
const (
	packageName = "cloud9"
	awsEnvVar   = "AWS_ENDPOINT_URL_CLOUD9"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := cloud9.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), cloud9.EndpointParameters{
