...
const (
	packageName = "elbv2"
	awsEnvVar   = "AWS_ENDPOINT_URL_ELASTIC_LOAD_BALANCING_V2"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "elastic_load_balancing_v2"

	aliasName0 = "elasticloadbalancingv2"
)
...
func defaultEndpoint(region string) (url.URL, error) {
	r := elasticloadbalancingv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), elasticloadbalancingv2.EndpointParameters{
