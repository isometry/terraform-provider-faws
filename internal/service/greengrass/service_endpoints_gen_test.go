...
const (
	packageName = "greengrass"
	awsEnvVar   = "AWS_ENDPOINT_URL_GREENGRASS"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := greengrass.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), greengrass.EndpointParameters{
