...
const (
	packageName = "acm"
	awsEnvVar   = "AWS_ENDPOINT_URL_ACM"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := acm.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), acm.EndpointParameters{
