...
const (
	packageName = "redshiftdata"
	awsEnvVar   = "AWS_ENDPOINT_URL_REDSHIFT_DATA"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "redshift_data"

	aliasName0 = "redshiftdataapiservice"
)
...
func defaultEndpoint(region string) (url.URL, error) {
	r := redshiftdata.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), redshiftdata.EndpointParameters{
