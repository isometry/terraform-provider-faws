...
const (
	packageName = "neptune"
	awsEnvVar   = "AWS_ENDPOINT_URL_NEPTUNE"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := neptune.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), neptune.EndpointParameters{
