...
const (
	packageName = "kafka"
	awsEnvVar   = "AWS_ENDPOINT_URL_KAFKA"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := kafka.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), kafka.EndpointParameters{
