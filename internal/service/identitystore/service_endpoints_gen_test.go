...
const (
	packageName = "identitystore"
	awsEnvVar   = "AWS_ENDPOINT_URL_IDENTITYSTORE"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "identitystore"
)
...
func defaultEndpoint(region string) (url.URL, error) {
	r := identitystore.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), identitystore.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	client := meta.IdentityStoreClient(ctx)
