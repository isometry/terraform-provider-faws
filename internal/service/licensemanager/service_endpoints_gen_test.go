...
const (
	packageName = "licensemanager"
	awsEnvVar   = "AWS_ENDPOINT_URL_LICENSE_MANAGER"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "license_manager"
)
...
func defaultEndpoint(region string) (url.URL, error) {
	r := licensemanager.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), licensemanager.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	client := meta.LicenseManagerClient(ctx)
