...
const (
	packageName = "fis"
	awsEnvVar   = "AWS_ENDPOINT_URL_FIS"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := fis.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), fis.EndpointParameters{
