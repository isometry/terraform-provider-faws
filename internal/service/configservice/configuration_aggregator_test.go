...
import (
	...
	tfconfig "github.com/isometry/terraform-provider-faws/internal/service/configservice"
...
func TestAccConfigServiceConfigurationAggregator_account(t *testing.T) {
	...
	//Name is upper case on purpose to test https://github.com/isometry/terraform-provider-faws/issues/8432
