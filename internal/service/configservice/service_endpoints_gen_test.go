...
const (
	packageName = "configservice"
	awsEnvVar   = "AWS_ENDPOINT_URL_CONFIG_SERVICE"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "config_service"
...
func defaultEndpoint(region string) (url.URL, error) {
	...
	ep, err := r.ResolveEndpoint(context.Background(), configservice.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	client := meta.ConfigServiceClient(ctx)
