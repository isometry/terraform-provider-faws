...
const (
	packageName = "directconnect"
	awsEnvVar   = "AWS_ENDPOINT_URL_DIRECT_CONNECT"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "direct_connect"
)
...
func defaultEndpoint(region string) (url.URL, error) {
	r := directconnect.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), directconnect.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	client := meta.DirectConnectClient(ctx)
