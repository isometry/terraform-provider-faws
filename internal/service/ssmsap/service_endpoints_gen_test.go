...
const (
	packageName = "ssmsap"
	awsEnvVar   = "AWS_ENDPOINT_URL_SSM_SAP"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := ssmsap.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), ssmsap.EndpointParameters{
