...
const (
	packageName = "emr"
	awsEnvVar   = "AWS_ENDPOINT_URL_EMR"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := emr.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), emr.EndpointParameters{
