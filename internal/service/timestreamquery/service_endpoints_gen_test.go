...
const (
	packageName = "timestreamquery"
	awsEnvVar   = "AWS_ENDPOINT_URL_TIMESTREAM_QUERY"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "timestream_query"
)
...
func defaultEndpoint(region string) (url.URL, error) {
	r := timestreamquery.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), timestreamquery.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	client := meta.TimestreamQueryClient(ctx)
