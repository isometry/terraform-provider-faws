...
const (
	packageName = "sesv2"
	awsEnvVar   = "AWS_ENDPOINT_URL_SESV2"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := sesv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), sesv2.EndpointParameters{
