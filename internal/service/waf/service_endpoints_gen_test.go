...
const (
	packageName = "waf"
	awsEnvVar   = "AWS_ENDPOINT_URL_WAF"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := waf.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), waf.EndpointParameters{
