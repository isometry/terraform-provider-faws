...
const (
	packageName = "qbusiness"
	awsEnvVar   = "AWS_ENDPOINT_URL_QBUSINESS"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "qbusiness"
)
...
func defaultEndpoint(region string) (url.URL, error) {
	r := qbusiness.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), qbusiness.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	client := meta.QBusinessClient(ctx)
