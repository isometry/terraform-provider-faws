...
func defaultEndpoint(region string) (url.URL, error) {
	r := m2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), m2.EndpointParameters{
