...
const (
	packageName = "amplify"
	awsEnvVar   = "AWS_ENDPOINT_URL_AMPLIFY"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := amplify.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), amplify.EndpointParameters{
