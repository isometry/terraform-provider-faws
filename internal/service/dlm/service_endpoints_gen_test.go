...
const (
	packageName = "dlm"
	awsEnvVar   = "AWS_ENDPOINT_URL_DLM"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := dlm.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), dlm.EndpointParameters{
