...
const (
	packageName = "ivs"
	awsEnvVar   = "AWS_ENDPOINT_URL_IVS"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := ivs.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), ivs.EndpointParameters{
