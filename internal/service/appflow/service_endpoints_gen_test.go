...
const (
	packageName = "appflow"
	awsEnvVar   = "AWS_ENDPOINT_URL_APPFLOW"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := appflow.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), appflow.EndpointParameters{
