...
const (
	packageName = "rbin"
	awsEnvVar   = "AWS_ENDPOINT_URL_RBIN"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "rbin"

	aliasName0 = "recyclebin"
)
...
func defaultEndpoint(region string) (url.URL, error) {
	r := rbin.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), rbin.EndpointParameters{
