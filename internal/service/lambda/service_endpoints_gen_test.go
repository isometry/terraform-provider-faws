...
const (
	packageName = "lambda"
	awsEnvVar   = "AWS_ENDPOINT_URL_LAMBDA"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := lambda.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), lambda.EndpointParameters{
