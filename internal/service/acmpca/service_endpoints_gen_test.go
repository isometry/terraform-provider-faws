...
const (
	packageName = "acmpca"
	awsEnvVar   = "AWS_ENDPOINT_URL_ACM_PCA"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := acmpca.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), acmpca.EndpointParameters{
