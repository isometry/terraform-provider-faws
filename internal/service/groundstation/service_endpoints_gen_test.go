...
const (
	packageName = "groundstation"
	awsEnvVar   = "AWS_ENDPOINT_URL_GROUNDSTATION"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "groundstation"
)
...
func defaultEndpoint(region string) (url.URL, error) {
	r := groundstation.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), groundstation.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	client := meta.GroundStationClient(ctx)
