...
const (
	packageName = "controltower"
	awsEnvVar   = "AWS_ENDPOINT_URL_CONTROLTOWER"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "controltower"
)
...
func defaultEndpoint(region string) (url.URL, error) {
	r := controltower.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), controltower.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	client := meta.ControlTowerClient(ctx)
