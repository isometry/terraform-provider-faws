...
const (
	packageName = "rekognition"
	awsEnvVar   = "AWS_ENDPOINT_URL_REKOGNITION"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "rekognition"
)
...
func defaultEndpoint(region string) (url.URL, error) {
	r := rekognition.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), rekognition.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	client := meta.RekognitionClient(ctx)
