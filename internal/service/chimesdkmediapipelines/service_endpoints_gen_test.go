...
const (
	packageName = "chimesdkmediapipelines"
	awsEnvVar   = "AWS_ENDPOINT_URL_CHIME_SDK_MEDIA_PIPELINES"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "chime_sdk_media_pipelines"
)
...
func defaultEndpoint(region string) (url.URL, error) {
	...
	ep, err := r.ResolveEndpoint(context.Background(), chimesdkmediapipelines.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	client := meta.ChimeSDKMediaPipelinesClient(ctx)
