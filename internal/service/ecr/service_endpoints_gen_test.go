...
const (
	packageName = "ecr"
	awsEnvVar   = "AWS_ENDPOINT_URL_ECR"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := ecr.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), ecr.EndpointParameters{
