...
const (
	packageName = "mgn"
	awsEnvVar   = "AWS_ENDPOINT_URL_MGN"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := mgn.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), mgn.EndpointParameters{
