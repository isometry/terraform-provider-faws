...
func defaultEndpoint(region string) (url.URL, error) {
	r := mq.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), mq.EndpointParameters{
