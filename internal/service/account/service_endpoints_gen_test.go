...
const (
	packageName = "account"
	awsEnvVar   = "AWS_ENDPOINT_URL_ACCOUNT"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := account.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), account.EndpointParameters{
