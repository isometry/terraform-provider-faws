...
const (
	packageName = "connectcases"
	awsEnvVar   = "AWS_ENDPOINT_URL_CONNECTCASES"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "connectcases"
)
...
func defaultEndpoint(region string) (url.URL, error) {
	r := connectcases.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), connectcases.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	client := meta.ConnectCasesClient(ctx)
