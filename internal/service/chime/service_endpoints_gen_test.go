...
const (
	packageName = "chime"
	awsEnvVar   = "AWS_ENDPOINT_URL_CHIME"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := chime.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), chime.EndpointParameters{
