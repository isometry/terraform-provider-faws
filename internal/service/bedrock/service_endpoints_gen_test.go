...
const (
	packageName = "bedrock"
	awsEnvVar   = "AWS_ENDPOINT_URL_BEDROCK"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := bedrock.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), bedrock.EndpointParameters{
