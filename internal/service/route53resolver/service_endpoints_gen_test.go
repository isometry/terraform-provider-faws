...
const (
	packageName = "route53resolver"
	awsEnvVar   = "AWS_ENDPOINT_URL_ROUTE53RESOLVER"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "route53resolver"
)
...
func defaultEndpoint(region string) (url.URL, error) {
	r := route53resolver.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), route53resolver.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	client := meta.Route53ResolverClient(ctx)
