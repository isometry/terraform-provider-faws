...
const (
	packageName = "grafana"
	awsEnvVar   = "AWS_ENDPOINT_URL_GRAFANA"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "grafana"

	aliasName0 = "managedgrafana"
	aliasName1 = "amg"
)
...
func defaultEndpoint(region string) (url.URL, error) {
	r := grafana.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), grafana.EndpointParameters{
