...
const (
	packageName = "appmesh"
	awsEnvVar   = "AWS_ENDPOINT_URL_APP_MESH"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "app_mesh"
)
...
func defaultEndpoint(region string) (url.URL, error) {
	r := appmesh.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), appmesh.EndpointParameters{
