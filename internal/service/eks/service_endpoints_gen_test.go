...
const (
	packageName = "eks"
	awsEnvVar   = "AWS_ENDPOINT_URL_EKS"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := eks.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), eks.EndpointParameters{
