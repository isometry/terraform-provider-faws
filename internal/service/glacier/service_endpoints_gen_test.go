...
const (
	packageName = "glacier"
	awsEnvVar   = "AWS_ENDPOINT_URL_GLACIER"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := glacier.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), glacier.EndpointParameters{
