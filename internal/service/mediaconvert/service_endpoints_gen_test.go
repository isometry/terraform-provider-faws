...
const (
	packageName = "mediaconvert"
	awsEnvVar   = "AWS_ENDPOINT_URL_MEDIACONVERT"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "mediaconvert"
)
...
func defaultEndpoint(region string) (url.URL, error) {
	r := mediaconvert.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), mediaconvert.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	client := meta.MediaConvertClient(ctx)
