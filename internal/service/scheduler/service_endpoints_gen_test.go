...
const (
	...
	awsEnvVar   = "AWS_ENDPOINT_URL_SCHEDULER"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "scheduler"
)
...
func defaultEndpoint(region string) (url.URL, error) {
	r := scheduler.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), scheduler.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	client := meta.SchedulerClient(ctx)
