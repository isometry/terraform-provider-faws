...
const (
	packageName = "networkfirewall"
	awsEnvVar   = "AWS_ENDPOINT_URL_NETWORK_FIREWALL"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "network_firewall"
)
...
func defaultEndpoint(region string) (url.URL, error) {
	r := networkfirewall.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), networkfirewall.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	client := meta.NetworkFirewallClient(ctx)
