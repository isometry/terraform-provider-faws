...
const (
	packageName = "ivschat"
	awsEnvVar   = "AWS_ENDPOINT_URL_IVSCHAT"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := ivschat.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), ivschat.EndpointParameters{
