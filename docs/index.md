...
In addition to contributions, we welcome [bug reports](https://github.com/isometry/terraform-provider-faws/issues/new?assignees=&labels=&template=Bug_Report.md) and [feature requests](https://github.com/isometry/terraform-provider-faws/issues/new?assignees=&labels=enhancement&template=Feature_Request.md).
